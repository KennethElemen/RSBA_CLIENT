...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $fetchStatusQuery = "SELECT benefits FROM crops WHERE user_id = ?";
    ...
    $newStatus = ($currentStatus == 'qualified') ? 'Pending' : 'qualified';

    // Update the accountStatus
    $updateUserQuery = "UPDATE crops SET benefits = ? WHERE user_id = ?";
