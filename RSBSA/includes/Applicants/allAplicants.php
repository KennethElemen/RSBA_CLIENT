<?php
												...
												$query = "SELECT 
													...
													GROUP BY 
														ua.user_id, ua.email, ua.accountStatus, ua.account_id, u.first_name, u.middle_name, u.sur_name, u.date_of_birth, u.profile_picture  -- Add profile_picture here
															...
															if ($row['accountStatus'] == 'Pending') {
																...
																echo '<td>
																		<button type="button" class="btn btn-primary btn-sm px-2"
																			...
																			data-profile-picture="' . htmlspecialchars($row['profile_picture']) . '">  <!-- Add this line -->
