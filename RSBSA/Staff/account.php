    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            // Location Details Box
                ...
                // Region and Address Concatenation
                $fullAddress = trim($row['region'] . ', ' . $row['province'] . ', ' . $row['city_municipality'] . ', ' . $row['barangay'] . ', ' . $row['street_number'] . ', ' . $row['purok'], ', ');
                echo '<div class="item border-bottom py-3">';
                echo '<strong>Full Address:</strong> ' . $fullAddress;
                echo '</div><!--//item-->';
